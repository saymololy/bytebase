...
var FeatureMatrix = map[FeatureType][3]bool{
	// Admin & Security
	FeatureSSO:                    {true, true, true},
	Feature2FA:                    {true, true, true},
	FeatureDisallowSignup:         {true, true, true},
	FeatureDisallowPasswordSignin: {true, true, true},
	FeatureSecureToken:            {true, true, true},
	FeaturePasswordRestriction:    {true, true, true},
	FeatureDomainRestriction:      {true, true, true},
	FeatureDirectorySync:          {true, true, true},
	FeatureExternalSecretManager:  {true, true, true},
	FeatureRBAC:                   {true, true, true},
	FeatureWatermark:              {true, true, true},
	FeatureAuditLog:               {true, true, true},
	FeatureCustomRole:             {true, true, true},
	FeatureIssueAdvancedSearch:    {true, true, true},
	FeatureAnnouncement:           {true, true, true},
	// Branding
	FeatureBranding: {true, true, true},
	// Change Workflow
	FeatureDBAWorkflow:         {true, true, true},
	FeatureMultiTenancy:        {true, true, true},
	FeatureOnlineMigration:     {true, true, true},
	FeatureSchemaDrift:         {true, true, true},
	FeatureSQLReview:           {true, true, true},
	FeatureTaskScheduleTime:    {true, true, true},
	FeatureEncryptedSecrets:    {true, true, true},
	FeatureDatabaseGrouping:    {true, true, true},
	FeatureSchemaTemplate:      {true, true, true},
	FeatureIssueProjectSetting: {true, true, true},
	// Database management
	FeatureReadReplicaConnection:         {true, true, true},
	FeatureInstanceSSHConnection:         {true, true, true},
	FeatureCustomInstanceSynchronization: {true, true, true},
	FeatureSyncSchemaAllVersions:         {true, true, true},
	FeatureIndexAdvisor:                  {true, true, true},
	// Policy Control
	FeatureRolloutPolicy:         {true, true, true},
	FeatureEnvironmentTierPolicy: {true, true, true},
	FeatureSensitiveData:         {true, true, true},
	FeatureAccessControl:         {true, true, true},
	FeatureCustomApproval:        {true, true, true},
	// Efficiency
	FeatureBatchQuery: {true, true, true},
	// Collaboration
